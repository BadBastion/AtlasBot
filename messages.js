...
pm.help = function(user){
    return "__**PM CHANNEL FUNCTIONS**__" +
           ...
           "• `!support` Alerts the mods that you need help with something\n" +
           "PLEASE NOTE :: Other functions will be avalable " +
           "__**WELCOME CHANNEL FUNCTIONS**__" +
           "• `!welcome` returns the welcome message (new to the server) \n" +
           "• `!support` Alerts the mods that you need help with something\n"
};
...
pm.welcome = function(user){
    return"Welcome to the Atlas Discord Server. You must link your Discord account with your Atlas forum account before you can join the other channels on the server.\n\n"+
        "To link your Atlas account, please post the following message on your Atlas forum profile: \n\n"+
        ...
        "Note that I am just a bot, so if you need help please post in the #verification-requests channel or pm one of the Staff. If you would like to see this message again, send me a private message with the text: !welcome"
};
